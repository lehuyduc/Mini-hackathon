...
public class GameConfig {
    ...
    public static final int DEFAULT_MAP_SIZE = 360;
    ...
    public static int WALL_RIGHT_WIDTH = DEFAULT_RIGHT_WALL_WIDTH;
    public static int WALL_DOWN_HEIGHT = DEFAULT_DOWN_WALL_HEIGHT;
