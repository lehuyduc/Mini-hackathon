...
import controllers.*;
import controllers.mummy.*;
import controllers.trap.TrapController;
...
public class GameLevel {
    ...
    private void levelSetting() {
        ...
        GameConfig.RIGHT_WALL_WIDTH = GameConfig.TILE_LENGTH / 8;
        GameConfig.DOWN_WALL_HEIGHT = GameConfig.TILE_LENGTH / 8;
    }
