...
public class PlayGameScreen extends GameScreen {
    ...
    public static int MAP_LEFT = 169, MAP_TOP = 33;
    ...
    public void update(Graphics g) {
        ...
        if (GameConfig.MAP_TILE_SIZE==6) {MAP_LEFT = 153; MAP_TOP = 21;}
        if (GameConfig.MAP_TILE_SIZE==8) {MAP_LEFT = 169; MAP_TOP = 34;}

        BufferedImage gameMap = new BufferedImage(GameConfig.MAP_SIZE, GameConfig.MAP_SIZE,
                BufferedImage.TYPE_INT_ARGB); // transparent

        // GameMap là bảng 480 x 480 tính cả viền exit. Ko tính viền thì là 360 x 360
